    ...
    try {
      ...
      return switch (tipoFiltro) {
        ...
        case FILTRO_FECHA_REPORTE ->
          new FiltroFechaReporte(dto.getFechaInicio().atStartOfDay(), dto.getFechaFin().atStartOfDay());
  ...
  public static Set<IFiltroStrategy> fromParams(
    ...
    if (fechaAcontecimientoDesde != null || fechaAcontecimientoHasta != null) {
      ...
      if (fechaAcontecimientoHasta == null) {
        ...
        filtros.add(new FiltroFechaAcontecimiento(fechaAcontecimientoDesde.atStartOfDay(),
            fechaAcontecimientoHasta.atStartOfDay()));
      }
    }
